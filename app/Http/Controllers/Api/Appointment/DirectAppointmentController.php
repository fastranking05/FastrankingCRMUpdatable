...
class DirectAppointmentController extends BaseApiController
{
    ...
    public function updateAppointmentByBusiness(Request $request, int $businessId): JsonResponse
    {
        $validator = Validator::make($request->all(), [
            ...
            'business.address_line1' => 'nullable|string|max:50',
            'business.city' => 'nullable|string|max:50',
            'business.postcode' => 'nullable|string|max:50',
            'business.country' => 'nullable|string|max:50',
