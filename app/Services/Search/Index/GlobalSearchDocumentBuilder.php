...
class GlobalSearchDocumentBuilder
{
    ...
    private function fromBusiness(FollowupBusiness $business): array
    {
        ...
        return $this->baseDocument(
            ...
            trim(implode(' • ', array_filter([$business->category, $business->type, $business->email]))),
            $searchText,
    ...
    private function fromContact(FollowupAuthPerson $contact): array
    {
        ...
        return $this->baseDocument(
            ...
            trim(implode(' • ', array_filter([$contact->designation, $contact->primaryemail, $contact->primarymobile]))),
            $searchText,
